...
BooklistsList.push(new Booklist('spanish', 'All Spanish novels.', 'A01',[BooksList[1]]))
...
function displayAllBooklists(e) {
    const booklistTable = document.querySelector('#booklistTable')
    ...
    if (e.target.className == 'collectIcon') {
        ...
        for (let i = 0; i < BooklistsNum; i++){
            if (BooklistsList[i].booklistID == index){
                ...
                booklistTable.children[i+2].children[4].children[1].children[1].innerText = "Collected: " + BooklistsList[i].collect
            }
        }
    }
    ...
    if (e.target.className == 'likeIcon') {
        ...
        for (let i = 0; i < BooklistsNum; i++){
            if (BooklistsList[i].booklistID == index){
                ...
                booklistTable.children[i+2].children[4].children[0].children[1].innerText = "Liked: " + BooklistsList[i].likes
            }
        }
    }
...
// load main list
window.addEventListener("load", displayAllBooklists)